...
The two popular approaches for 2D class averaging \cite{} in cryo-EM are multivariate statistical analysis (MSA)\cite{} with multi-reference alignment (MRA) \cite{} and iterative reference-free alignment using K-means clustering \cite{}.
