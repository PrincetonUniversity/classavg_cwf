function [data, compressed_den_coeff, denoised_coeff_ccwf, basis] =  data_CWF(images, CTF, index, noise_v_r, ndef, def1, def2, B, lambda, use_CTF)
...
data.Coeff=cell2mat(compressed_den_coeff);
data.Freqs=basis.ang_freqs(1:size(data.Coeff,1));
data.c=c;
data.R=R;
